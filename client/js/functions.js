...
//Note: moved to meteor
     ...
     * Dropdown Menu
     */
    //Note: this was NOT moved to meteor.  I couldn't convert this but it is
    //needed for "holding" the notification dropdown menu while they're removed ...
    if($('.dropdown')[0]) {
        //Propagate
     ...
     * Clear Local Storage
     */
    //moved to meteor ... but, didn't know what swal() was ???
    //if ($('[data-action="clear-localstoragex"]')[0]) {
